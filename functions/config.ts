export const config = {
    "adalConfig": {
        ...
        "subscriptionUrl": "https://us-central1-future-app-backend.cloudfunctions.net/echo",
    ...
    "webhookConfig": {
        ...
        "clientState": "915fbff2-e710-46c8-8888-e1277df50539" // "secret" code that sharepoint will post back to verify request is comming from them
    }
}
