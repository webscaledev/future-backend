# Contributing to TFG-app

We would love for you to contribute to the TFG-app and help make it even better than it is
...
Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/tfg) where the questions should be tagged with tag `tfg-app`.
...
1. Search [GitHub](https://github.com/webscaledev/futureApp/pulls) for an open or closed PR
  that relates to your submission. You don't want to duplicate effort.
1. Fork the webscaledev/futureApp repo.
...
1. In GitHub, send a pull request to `futureApp:master`.
