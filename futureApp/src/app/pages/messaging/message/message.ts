...
export class MessagePage implements OnInit {
  ...
  ngOnInit() {
    console.log("ngOnInit MessagePage");
  }
    ...
    this.messages = [
      {
        ...
        body: `Hello,
          I came across your profile and your background looks like it could be a great fit for a
          fast-growing company like us. So let’s get connected for further discussion.
